      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
          ...
          <div className="relative rounded-2xl overflow-hidden bg-white dark:bg-slate-800 shadow-xl border border-gray-100 dark:border-slate-700">
            ...
            <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600" />
            ...
            <div className="p-8 md:p-10">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                >
                  <Button
                    type="submit"
                    className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-semibold py-3 rounded-lg transition-all duration-300 transform hover:scale-[1.01] active:scale-95 flex items-center justify-center gap-2"
              ...
              <div className="my-6 relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white dark:bg-slate-800 text-gray-500">New to Outstanding?</span>
                </div>
              </div>
